...
<template>
  ...
  >
    <div class="vinyl-image">
      ...
      <span v-if="card.important" class="flag-important" title="В первую очередь">★</span>
    ...
    <div class="vinyl-info">
      ...
      <div class="card-footer">
        ...
        <Transition v-if="editable" name="fade" mode="out-in">
          <button
              v-if="!isPurchased"
              class="buy-toggle"
          ...
          <button
              v-else
              class="buy-toggle is-done"
              @click.prevent="handleTogglePurchased"
          >
            ✓ Куплен
          </button>
        </Transition>
        <span v-else-if="isPurchased" class="buy-toggle is-done static">✓ Куплен</span>
      </div>
    </div>
  </a>
</template>
